...
namespace BankManagementSystem
{
    public partial class TransferMoney : Form
    {
        ...
        void totalWithdrawal()
        {
            ...
            string query = "select sum(amount) amt from Withdrawal where id='" + txttransfrereacc.Text + "' group by id"; ;
        ...
        void totaldeposite()
        {
            ...
            string query = "select sum(amount) amt from deposite where id='" + txttransfrereacc.Text + "' group by id"; ;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string name = "Transfered-" + txttransfrereacc.Text + "-" + txtname.Text;

                    int id = Convert.ToInt32(txttransfrereacc.Text);
        ...
        private void SearchTran_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            try
            {
                totaldeposite();
